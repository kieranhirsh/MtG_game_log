...
class Game_validator():
    def is_valid(new_game):
        ...
        Game_validator.valid_datetime(new_game["start_time"])
        Game_validator.valid_datetime(new_game["end_time"])
    ...
    def valid_datetime(datetime):
        ...
        is_valid_datetime = re.search("^[1-9]([0-9]){3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[0-1])( ([01][0-9]|2[0-3])(:[0-5][0-9]){0,2}){0,1}$", datetime)
