...
def colour_identities_post():
    ...
    return Colour_Identity_crud.create()
...
def colour_identities_get_specific(colour_identity_id):
    ...
    return Colour_Identity_crud.specific(colour_identity_id)
...
def colour_identities_edit(colour_identity_id):
    ...
    return Colour_Identity_crud.update(colour_identity_id)
...
def colour_identities_get_decks(colour_identity_id):
    ...
    return Colour_Identity_crud.get_child_data(colour_identity_id, child_type="decks")
...
def colour_identities_delete(colour_identity_id):
    ...
    return Colour_Identity_crud.delete(colour_identity_id)
