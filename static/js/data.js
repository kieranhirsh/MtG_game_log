...
function sortColourTables(col, tab) {
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
  ...
  if (tab == 1) {
    for (var j = 2; j < 5; j++) {
      sortColourTables(col, j)
    }
  }
}

function sortColourTablesBroken(col) {
/* This function only sorts table 1, but not 2, 3, or 4
    I cannot for the lif of me work out why that is,
    especially because the recursive function above works just fine
    if I do work it out this function will replace the above */
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
