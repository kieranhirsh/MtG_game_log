...
class deck_crud():
    ...
    def specific(query_tree={}, join_classes=[], key="", value="", return_model_object=False):
        ...
        output = {
            ...
            "commander_name": result[0].commander_name,
            "partner_name": result[0].partner_name,
            "companion_name": result[0].companion_name,
    ...
    def create(data = "", return_model_object = False):
        ...
        output = {
            ...
            "commander_name": new_deck.commander_name,
            "partner_name": new_deck.partner_name,
            "companion_name": new_deck.companion_name,
    ...
    def update(deck_id, data = "", return_model_object = False):
        ...
        output = {
            ...
            "companion_name": result.companion_name,
    ...
    def get_sibling_data(deck_id, parent_type, return_model_object = False):
        ...
        for sibling in sibling_data:
            output.append({
                ...
                "commander_name": sibling.commander_name,
                "partner_name": sibling.partner_name,
                "companion_name": sibling.companion_name,
